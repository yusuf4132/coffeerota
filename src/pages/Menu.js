  ...
  return (
    <React.Fragment>
      ...
      <section className="main-content menu">
        <h3>İçecekler</h3>
        <p><span className="sans-bold">Milk Selections:</span> Low Fat, Skim, Half & Half, Almond, Oat</p>
        <p><span className="sans-bold">House Made Syrups $0.50:</span> Mocha, White Mocha, Caramel, Vanilla, Cinnamon, Raspberry, Hazelnut, Lavender</p>
        <h4>Coffee</h4>
